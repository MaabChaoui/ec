...
import { MaladieAddDialog } from "./maladie-add-dialog";

interface MaladieHeaderProps {
  ...
  return (
    <div className="mb-8">
      ...
      <div className="bg-gray-50 rounded-lg p-4 flex items-center justify-between">
          ...
          <div className="relative">
            <Select value={orderStatusFilter} onValueChange={onOrderStatusFilterChange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="treatable">Treatable</SelectItem>
        ...
        {/* Right side - ADD Dialog */}
        <MaladieAddDialog onMaladieCreated={onMaladieCreated} />
      </div>
    </div>
  );
}